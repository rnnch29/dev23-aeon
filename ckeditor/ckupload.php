...
include("../weadmin/lib/session.php");
	$url = 'upload/files/id' . $_SESSION[$valSiteManage . 'core_session_id'].'/'.time()."_".$_FILES['upload']['name'];
	$urlSite="/dev23-aeon/ckeditor/";
...
if($_SESSION[$valSiteManage . 'core_session_id']>=1){
 ...
 //extensive suitability check before doing anything with the file...
	...
	$countDotFile = substr_count($_FILES['upload']['name'], '.'); 
		if($countDotFile==1){
		  $message = "";
