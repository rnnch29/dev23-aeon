...
function delThumbUpload(fileAc) {
    ...
    jQuery.ajax({
        ...
        success: function(html) {
            ...
            jQuery("#boxThumbNew").show();
            jQuery("#boxThumbNew").html(html);
            setTimeout(jQuery.unblockUI, 200);
...
function delPicUpload_multi(fileAc, ele) {
...
function onLoadFCK() {
    ...
    var roxyFileman = '/dev23-aeon/fileman/index.php';
